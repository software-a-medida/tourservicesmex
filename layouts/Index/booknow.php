                            ...
                            <fieldset class="col-12 p-r-0 p-r-md-10 m-b-10">
                                ...
                                <select name="tour" class="p-l-20 p-r-20" style="width:100%;height:50px;border:0px;border-radius:2px;background-color:#f5f5f5;">
                                    <optgroup label="{$lang.our_home_tour}">
                                        <option value="ek" data-url="/book-now/ek-balam-yalcoba-santa-rita" data-image="{$path.images}ek_bg_1_desktop.jpg" <?php echo (($global['render'] == 'ek-balam-yalcoba-santa-rita') ? 'selected' : ''); ?>>Ek-Balam + Yalcobá + Santa Rita</option>
                                    </optgroup>
                                    <optgroup label="{$lang.others_tours}">
                    ...
                    <div class="col-md-6">
                        <div class="row no-gutters">
                            ...
                            <fieldset class="col-12 p-l-0 p-l-md-20 p-r-0 p-r-md-20 m-b-20">
                                <p class="text-justify" style="font-size:12px!important;">{$lang.to_book_with_us_1} <strong><?php echo Configuration::$vars['contact']['phone']; ?></strong>, {$lang.to_book_with_us_2} <strong><?php echo Configuration::$vars['contact']['email']; ?></strong>. {$lang.to_book_with_us_3} <a href="/terms-and-conditions" class="text-dark"><strong>{$lang.terms_and_conditions}</strong></a> {$lang.to_book_with_us_4} <a href="/privacy-notice" class="text-dark"><strong>{$lang.privacy_notice}</strong></a>.</p>
                            </fieldset>
