...
$this->dependencies->add(['js', '{$path.js}Index/rl.js?v=1.0']);
...
<main>
    <section class="pos-relative" style="height:80vh;min-height:600px;">
        <figure style="height:100%;">
            <img src="{$path.images}rl_bg_1.jpg" data-desktop class="img-cover">
        </figure>
        <div class="pos-absolute d-flex align-items-center p-20 p-md-40" style="top:0px;right:0px;bottom:0px;left:0px;background-color:rgba(0,0,0,0.4);">
            <div class="container">
                <h1 class="m-b-20 m-b-md-40 text-center text-light">Rio Lagartos</h1>
                <p class="m-b-20 m-b-md-40 text-center text-light">{$lang.rl_tt_2}</p>
                <div class="d-flex justify-content-center">
                    <a href="/book-now/rio-lagartos" class="btn" style="width:100%;max-width:200px;">{$lang.book_now}</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6 m-b-20 m-b-md-0">
                    <h2 class="m-b-20 m-b-md-40">1. Rio Lagartos</h2>
                    <p class="text-justify">{$lang.rl_tt_3}</p>
                </div>
                <div class="col-md-6">
                    <div class="row no-gutters">
                        <div class="col-4 p-l-0 p-l-md-10 m-b-0 m-b-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_1.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_1.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                        <div class="col-4 p-l-0 p-l-md-10 m-b-0 m-b-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_2.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_2.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                        <div class="col-4 p-l-0 p-l-md-10 m-b-0 m-b-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_3.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_3.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                        <div class="col-4 p-l-0 p-l-md-10 m-b-0 m-b-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_4.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_4.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                        <div class="col-4 p-l-0 p-l-md-10 m-b-0 m-b-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_5.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_5.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                        <div class="col-4 p-l-0 p-l-md-10 m-b-0 m-b-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_6.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_6.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                        <div class="col-4 p-l-0 p-l-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_7.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_7.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                        <div class="col-4 p-l-0 p-l-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_8.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_8.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                        <div class="col-4 p-l-0 p-l-md-10">
                            <figure class="pos-relative" style="height:140px;">
                                <img src="{$path.images}rl_gl_9.jpg" class="img-cover">
                                <a href="{$path.images}rl_gl_9.jpg" rel="rl" data-fancybox style="position:absolute;top:0px;right:0px;bottom:0px;left:0px;"></a>
                            </figure>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 m-b-20 m-b-md-0">
                    ...
                    <h6 class="p-l-20 p-l-md-0 m-b-5 m-b-md-10"><i class="fas fa-check m-r-10" style="color:#009688;"></i>{$lang.boat}</h6>
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        <a href="/book-now/rio-lagartos" class="btn btn-block">{$lang.book_now}</a>
                    </div>
                </div>
            </div>
        </div>
