					...
					<div data-desktop class="col-10">
						<nav>
							<ul class="d-flex align-items-center list-unstyled">
								...
								<li class="m-r-20"><a href="/contact-us" class="text-light" style="font-size:14px;">{$lang.contact_us}</a></li>
								<li class="m-r-20"><a href="/book-now/ek-balam-yalcoba-santa-rita" class="btn btn-dark text-light" style="font-size:14px;">{$lang.book_now}</a></li>
								<li class="m-r-20"><a href="/others-tours" class="text-light" style="font-size:14px;">{$lang.others_tours}</a></li>
								<li><a href="/ek-balam-yalcoba-santa-rita" class="text-light" style="font-size:14px;">{$lang.our_home_tour}</a></li>
							</ul>
						</nav>
					</div>
		...
		<header id="mobile_menu" data-mobile-flex class="pos-fixed d-flex align-items-center justify-content-center flex-column p-20" style="width:300px;height:100vh;left:-300px;background-color:#000;transition:400ms;z-index:99;">
			...
			<nav>
				<ul class="d-flex align-items-center flex-column list-unstyled">
					<li class="m-b-10"><a href="/ek-balam-yalcoba-santa-rita" class="text-light" style="font-size:14px;">{$lang.our_home_tour}</a></li>
					<li class="m-b-20"><a href="/others-tours" class="text-light" style="font-size:14px;">{$lang.others_tours}</a></li>
					<li class="m-b-20"><a href="/book-now/ek-balam-yalcoba-santa-rita" class="btn btn-light text-light" style="font-size:14px;">{$lang.book_now}</a></li>
					<li class="m-b-10"><a href="/contact-us" class="text-light" style="font-size:14px;">{$lang.contact_us}</a></li>
