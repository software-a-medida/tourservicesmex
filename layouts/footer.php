<?php defined('_EXEC') or die; ?>
        ...
        <footer class="p-20 p-md-40" style="background-color:#000;">
            <div class="container">
                <div class="row">
                    <div class="col-12 m-b-10 m-b-md-0">
                        <a href="/terms-and-conditions" class="d-inline-block m-r-10 m-b-10 m-b-md-5 text-center text-md-left text-light" style="font-size:14px;">{$lang.terms_and_conditions}</a>
                        <a href="/privacy-notice" class="d-inline-block m-b-10 m-b-md-5 text-center text-md-left text-light" style="font-size:14px;">{$lang.privacy_notice}</a>
